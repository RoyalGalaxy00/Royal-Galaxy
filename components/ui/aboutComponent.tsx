        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full md:w-1/2 flex flex-col space-y-6 md:space-y-8">
            <div className="space-y-2">
              <h3 className="text-[#0a7a7b] font-medium tracking-widest uppercase text-sm md:text-base">Our Story</h3>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-gray-900 leading-tight">
                We Strive Only For <span className="text-[#0a7a7b]">The Best</span>
              </h2>
            </div>
