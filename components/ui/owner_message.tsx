        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full md:w-1/2 flex flex-col space-y-6 md:space-y-8">
            ...
            <div className="space-y-4 text-gray-600 text-base md:text-lg leading-relaxed font-light">
              <p>
                Nestled in the vibrant heart of Sauha, Chitwan, Royal Galaxy
                Hotel & Lodge offers a harmonious blend of regal comfort and the
                raw beauty of Nepal’s wilderness. Our doors open to a world
                where the luxurious amenities of a premier hotel meet the
                tranquil rhythms of nature. Whether you are gazing out at the
                lush landscape or stepping out to explore the famed Chitwan
